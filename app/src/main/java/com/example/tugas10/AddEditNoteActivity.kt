...
class AddEditNoteActivity : AppCompatActivity() {
    companion object {
        ...
        const val EXTRA_JURUSAN = "com.example.catatanku.EXTRA_JURUSAN"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.hasExtra(EXTRA_ID)) {
            ...
            edit_text_description.setText(intent.getStringExtra(EXTRA_JURUSAN))
    ...
    private fun saveNote() {
        ...
        val data = Intent().apply {
            ...
            putExtra(EXTRA_JURUSAN, edit_text_description.text.toString())
